...
| Kernel   | upcie-experimental         | {{ ver_upcie_experimental }} | DKMS  | 26.04 stack: out-of-tree modules released by uPCIe; the dma-buf importer and the IOMMU physical-address mapper                       |
