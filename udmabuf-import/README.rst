...
This directory contains a patch adding *dma-buf* importer functionality to
...
* Configure::
	  ...
	  scripts/config --disable DEBUG_INFO; scripts/config --set-str \
	  SYSTEM_TRUSTED_KEYS ""; scripts/config --set-str SYSTEM_REVOCATION_KEYS ""; \
